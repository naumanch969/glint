...
const About = () => {
    ...
    return (
        ...
        >
            ...
            >
                <p className='md:text-[24px] sm:text-[20px] text-white md:text-end text-center lg:pl-[7rem] md:pl-[7rem] ' >I'm <span className='font-[cursive] font-bold text-[32px] gradient-text ' >Nauman Chaudhry</span>, a seasoned <span className='font-bold' >MERN stack</span> developer with a passion for crafting exceptional digital experiences. With over two years of dedicated experience, I've had the privilege of working on a diverse range of projects. These include comprehensive full-stack web applications and meticulously designed RESTful APIs, all powered by technologies like MongoDB, Express.js, React.js, and Node.js.</p>
